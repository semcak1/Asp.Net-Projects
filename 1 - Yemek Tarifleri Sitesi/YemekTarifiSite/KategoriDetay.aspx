...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style1">
            ...
            <tr>
                <td style="border-style: none; border-color: #FFFFFF"><strong><a href="YemekDetay.aspx?YemekId=<%#Eval("YemekId") %>">
            ...
            <tr>
                <td style="border-style: none; border-width: medium; border-color: #000000"><strong>Tarih :</strong>
